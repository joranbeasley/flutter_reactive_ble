...
struct DeviceScanInfo {
  ...
  var rawScanRecordData: Data = Data()
...
extension DeviceScanInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .same(proto: "rssi"),
    8: .same(proto: "rawScanRecordData"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularBytesField(value: &self.rawScanRecordData) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.rawScanRecordData.isEmpty {
      try visitor.visitSingularBytesField(value: self.rawScanRecordData, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: DeviceScanInfo, rhs: DeviceScanInfo) -> Bool {
    ...
    if lhs.rawScanRecordData != rhs.rawScanRecordData {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
